...
try:
    import google.generativeai as genaiimport pandas as pd
import streamlit as st
import json
import re
import random
...
def generate_natural_ai_sentence(word, definition="", pos=""):
    """用 Gemini 產生原創、學生可學習的自然例句；失敗就回傳空字串，不製造模板句。"""
...
def get_word_record_data(word, definition="", pos=""):
    """建立單字資料：人工例句 → AI 高品質原創例句；絕不使用垃圾模板句。"""
